...
#
# Reference
# Manh Nguyen Duc (2024) Contact tracing form using KoboToolbox
...
# This code consists of three parts: (i) preparation of the contact network;
